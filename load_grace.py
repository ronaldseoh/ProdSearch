...
from GRACE.ate_asc_modeling import BertForSequenceLabeling
...
def load_grace_model(model_path, bert_arch_name='bert-base-uncased',
                     num_tp_labels=(3,5), at_labels=['O', 'B-AP', 'I-AP'],
